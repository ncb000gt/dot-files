...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/ncampbell/.eclipse/org.eclipse.platform_3.7.0_155965261/plugins/org.eclim_1.7.2'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/ncampbell/.eclipse/org.eclipse.platform_3.7.0_155965261'
  if has('win32unix')
